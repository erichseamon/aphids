...
author: "Subodh A, Sanford Eigenbrode, Erich Seamon"
date: "10/22/2021"
fontsize: 12pt
output:
  pdf_document:
...
rownames(models) <- c("Winter Wheat", "Spring Wheat", "All Wheat", "All Cereals", "All Grasslands", "All Legumes", "Cumulative Degree Days", "Cumulative Precip" )
models <- t(models)
...
model_other <- subset(models2, Var1 == "TotRp" | Var1 == "TotSa" | Var1 == "TotMd" | Var1 == "TotMfc" | Var1 == "TotSe")
